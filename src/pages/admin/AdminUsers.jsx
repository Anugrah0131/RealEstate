...
import { HiOutlineIdentification, HiOutlineLockClosed, HiOutlineLockOpen, HiOutlineMail, HiOutlineTrash } from "react-icons/hi";
    ...
    const handleBlock = async (id) => {
        try {
            ...
            if (res.data.success) {
                setUsers(
                    users.map((u) =>
                        u._id === id ? { ...u, isBlocked: res.data.user.isBlocked } : u,
                    ),
                );
            }
        } catch (err) {
